...
const QuantityPrice = () => {
	...
	return (
		<div className='md:swdc-w-1/2 swdc-border-r swdc-border-[#ccc] swdc-mr-4 swdc-pr-5 sm:swdc-pr-3 sm:swdc-mr-1 md:swdc-border-0 md:swdc-pr-0 md:swdc-mr-1 lg:swdc-pr-1'>
