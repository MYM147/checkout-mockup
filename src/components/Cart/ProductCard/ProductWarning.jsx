			...
			<div className='md:swdc-ml-[15%] sm:swdc-ml-2'>
				<div className='swdc-text-xs sm:swdc-flex-col'>
					<div className='swdc-flex md:swdc-order-1 swdc-order-2'>
						<div className='swdc-pr-2 swdc-w-[280px]'>
							<ul className='swdc-flex swdc-justify-evenly swdc-font-bold'>
								<li className='swdc-ml-1 hover:swdc-underline'>
									<Button
										variant='text'
										className='swdc-text-[#0069ae] swdc-text-[0.95em] hover:swdc-bg-white swdc-normal-case'>
										Edit
									</Button>
								</li>
