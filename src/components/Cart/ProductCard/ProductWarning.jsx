  ...
  return (
		<>
			<div className='md:swdc-ml-[15%] sm:swdc-ml-2'>
				<div className='swdc-text-xs swdc-flex swdc-flex-col'>
						...
						<div className='swdc-pr-2 swdc-w-[270px]'>
							<ul className='swdc-flex swdc-justify-evenly'>
								<li className='swdc-ml-1 hover:swdc-underline'>
									<Button
										variant='text'
										className='swdc-text-[#0069ae] swdc-text-[0.95em] hover:swdc-bg-white swdc-normal-case swdc-tracking-widest'>Edit
									</Button>
								</li>
					...
					<div className='swdc-flex swdc-w-full md:swdc-w-[73%] md:swdc-relative md:swdc-left-1 md:swdc-mb-2 md:swdc-mt-0 swdc-mt-3 swdc-px-2 swdc-order-1'>
